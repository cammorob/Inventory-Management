...
namespace Inventory_Management
{
        ...
        public class DataGridPrinter
        {
            ...
            int columnsCount = TheDataGrid.Columns.Count;
            ...
            else
            {
                ...
                Console.WriteLine("Error: No columns to print.");
            ...
            g.DrawLine(TheLinePen, LeftMargin, headerHeight + TopMargin, LeftMargin + PageWidth, headerHeight + TopMargin);
                ...
                HeaderBounds.Y = headerHeight + TopMargin + (RowCount) * (TheDataGrid.Font.SizeInPoints + kVerticalCellLeeway);
                ...
                for (int k = 0; k < columnsCount; k++)
                {
                    ...
                    RectangleF cellbounds = new RectangleF(startxposition, headerHeight + TopMargin + (RowCount ) * (TheDataGrid.Font.SizeInPoints + kVerticalCellLeeway),
                        thisComunWidth,
        ...
        {
            myDataGridView.DataSource = reportsPage.reportdataGridView;
